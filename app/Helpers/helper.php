...
function getProdiAkses()
{
    //$hak_akses = Auth::user()->ProdiID;
    $hak_akses = "SI";
    $p = explode(',', $hak_akses); // Pemisahan string menjadi array
    $prodiakses = Prodi_model::whereIn('ProdiID', $p)->get(); // Menggunakan whereIn langsung dengan array
    return $prodiakses;
}
